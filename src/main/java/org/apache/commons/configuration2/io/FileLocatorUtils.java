...
public final class FileLocatorUtils {
     ...
     */
    static @RUntainted File constructFile(final String basePath, final @RUntainted String fileName) {
        final File file;
     ...
     */
    static @RUntainted URL convertFileToURL(final @RUntainted File file) {
     ...
     * @return the resulting URL or <b>null</b>
     */
    static @RUntainted URL convertURIToURL(final @RUntainted URI uri) {
        try {
            return uri.toURL();
     ...
     */
    static @RUntainted String getBasePath(final @RUntainted URL url) {
        if (url == null) {
            return null;
        }
     ...
     */
    static @RUntainted URL getClasspathResource(final @RUntainted String resourceName) {
        URL url = null;
     ...
     */
    static @RUntainted String getFileName(final @RUntainted URL url) {
        if (url == null) {
            return null;
        }
     ...
     */
    static @RUntainted URL toURL(final @RUntainted File file) throws MalformedURLException {
